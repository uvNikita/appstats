...
from .metrics import request_tracking_middleware, patch_redis, patch_mongo


patch_redis(StrictRedis, StrictPipeline)
patch_mongo(MongoClient)
cantal.start()


class App(FlaskMixin, Flask):
    pass
